 ...
 */
package mod.azure.azurelib.client.config;
...
import mod.azure.azurelib.client.config.screen.ArrayConfigScreen;
import mod.azure.azurelib.client.config.screen.ConfigScreen;
import mod.azure.azurelib.client.config.widget.BooleanWidget;
import mod.azure.azurelib.client.config.widget.ColorWidget;
import mod.azure.azurelib.client.config.widget.ConfigEntryWidget;
import mod.azure.azurelib.client.config.widget.EnumWidget;
import mod.azure.azurelib.common.config.ConfigUtils;
import mod.azure.azurelib.common.config.Configurable;
import mod.azure.azurelib.common.config.validate.ValidationResult;
import mod.azure.azurelib.common.config.value.*;

@FunctionalInterface
public interface DisplayAdapter {

    static DisplayAdapter booleanValue() {
        return (value, field, container) -> container.addConfigWidget(
            (x, y, width, height, configId) -> new BooleanWidget(
                getValueX(x, width),
                y,
                getValueWidth(width),
                20,
    ...
    static DisplayAdapter enumValue() {
        return (value, field, container) -> container.addConfigWidget(
            (x, y, width, height, configId) -> new EnumWidget<>(
                getValueX(x, width),
                y,
                getValueWidth(width),
                20,
