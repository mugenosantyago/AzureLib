package mod.azure.azurelib.client.utils;
...
public record ClientUtils() {
    ...
    /**
     * Rotates the given PoseStack to align with the orientation of the specified Entity. The rotation is based on the
     * interpolated yaw and pitch values of the Entity.
     *
     * @param poseStack   the PoseStack that will be rotated
     * @param animatable  the Entity whose orientation determines the rotation
