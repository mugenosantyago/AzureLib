 ...
 */
package mod.azure.azurelib.client.config.screen;
...
import mod.azure.azurelib.client.config.DisplayAdapter;
import mod.azure.azurelib.client.config.widget.ConfigEntryWidget;
import mod.azure.azurelib.common.config.ConfigHolder;

import static mod.azure.azurelib.client.config.screen.AbstractConfigScreen.FOOTER_HEIGHT;
import static mod.azure.azurelib.client.config.screen.AbstractConfigScreen.HEADER_HEIGHT;
